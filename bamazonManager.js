        ...
        inquirer.prompt([
            ...
            switch (answers.command) {
                case 'View Products for Sale':
                    utils.displayInventory(connection, promptManager)
                    // connection.end()
                    break;
...
// MANAGER SPECIFIC PROMPT FUNCTIONS + CALLBACKS://
// **********************************************//
function promptForInventory(callback) {
    inquirer.prompt([
        ...
        callback(productID, stockToAdd, updateInventory);
    })
}
...
function queryById(ID, stockToAdd, callback) {
